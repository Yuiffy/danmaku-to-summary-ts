...
exports.ColorConsoleFormatter = exports.JsonLogFormatter = exports.DefaultLogFormatter = void 0;
...
class ColorConsoleFormatter {
    colors = {
        [LoggerInterface_1.LogLevel.ERROR]: '\x1b[31m', // 红色
        [LoggerInterface_1.LogLevel.WARN]: '\x1b[33m', // 黄色
        [LoggerInterface_1.LogLevel.INFO]: '\x1b[32m', // 绿色
        [LoggerInterface_1.LogLevel.DEBUG]: '\x1b[36m', // 青色
        [LoggerInterface_1.LogLevel.VERBOSE]: '\x1b[90m' // 灰色
    };
    resetColor = '\x1b[0m';
    format(entry) {
        const timestamp = entry.timestamp.toISOString();
...
exports.ColorConsoleFormatter = ColorConsoleFormatter;
