...
class MultiReferenceComicTests(unittest.TestCase):
    ...
    def test_delayed_reply_virtual_streamers_have_existing_character_references(self):
        ...
        expected_references = {
            ...
            "public/reference_images/sumi_standing_transparent.png",
        ...
        expected_room_references = {
            ...
            "23222837": "public/reference_images/sumi_standing_transparent.png",
    ...
    def test_second_prompt_build_preserves_fresh_script_provenance(self):
        ...
        comic.set_comic_script_meta(provider="daiYu", model="gpt-6-luna", status="success")
        ...
        self.assertEqual(meta["model"], "gpt-6-luna")
