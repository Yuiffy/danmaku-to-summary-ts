...
COMIC_SCRIPT_POLICY_VERSION = 13
...
- 对正文确实出现的游戏、影视、歌曲或故事，可以采用对应作品的舞台和环境，让主播参与其中；仍须保留主播身份特征，不得直接替换成作品角色。已识别的现成作品人物必须保持原作身份与外观，不能改造成“作品氛围启发”的原创替代人物；只有无法识别具体作品或内容本来没有固定角色时，才使用无名剪影或氛围化人物。
...
若漫画脚本或明确语音已识别出现成动画、影视或游戏作品，作品名与角色名是身份约束，不是要求画出的文字。屏幕内或作品世界中的人物必须是该作品的实际角色，并结合脚本请求的直播截图还原其发型、脸、服装和人数；不要生成同题材原创人物来替代。若输入图不足以确认某人的外观，就减少该人物、放在远景或保留背影，不要凭空补一张原创正脸。
{multi_constraints}
{reference_manifest_block}
{reference_record_rules}
{immersive_image_rules}
...
3. 对正文确实出现的游戏、影视、歌曲或故事，让主播进入对应舞台和环境，但必须保留主播身份特征，不要直接替换成作品角色。若正文或弹幕已经明确给出现成作品名（允许纠正明显的ASR错字），必须在scene和referenceUsage中保留其规范作品名；画面里的作品人物必须是该作品的实际角色并按原作或直播截图还原，不能设计成“作品氛围启发”的原创替代人物。只有无法可靠识别具体作品，或内容本来就是抽象歌曲、口述故事时，才使用不冒充具体角色的氛围化环境与无名剪影。
